...
def executar():
    ...
    dados_kit = [
        {'TECNOLOGIA': 'HFC', 'DESCRICAO': '3.1 DUAL BAND (200mb em diante)', 'QTD_KIT': 5},
        ...
        {'TECNOLOGIA': 'GPON', 'DESCRICAO': 'ONT - GPOM - WIFI6', 'QTD_KIT': 0},
        {'TECNOLOGIA': 'GPON', 'DESCRICAO': 'ONT - GPON', 'QTD_KIT': 8},
        {'TECNOLOGIA': 'GPON', 'DESCRICAO': 'ROTEADOR', 'QTD_KIT': 0},

        {'TECNOLOGIA': 'VT', 'DESCRICAO': '3.1 DUAL BAND (200mb em diante)', 'QTD_KIT': 6},
        {'TECNOLOGIA': 'VT', 'DESCRICAO': 'DECODER HD CABO IP  VOZ (TV BOX HFC IP)', 'QTD_KIT': 0},
        ...
        {'TECNOLOGIA':'VT', 'DESCRICAO': 'DECODER 4K STREAMING', 'QTD_KIT': 0},
